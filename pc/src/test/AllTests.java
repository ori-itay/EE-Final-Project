...
class AllTests {
	...
	@Test
	void testEncodeDecodeEncodeIdempotent() throws Exception {
	...
	@Test
	void testEncodeDecodeEncodeRotatedIdempotent() throws Exception {
	...
	@Test
	void testEncodeLongest() throws Exception {
