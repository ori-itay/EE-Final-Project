...
public class DisplayDecoder {
	...
	public static void main(String... args) throws Exception {
		...
		RotatedImageSampler imageSampler = decodeImage(encodedImage);
		//print data for testing
		System.out.println(imageSampler.decodedData);
	}
	
	public static RotatedImageSampler decodeImage(BufferedImage encodedImage) throws Exception {
